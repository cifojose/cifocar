			...
			<table>
				...
				foreach($vehiculos as $vehiculo){
				    echo "<tr>";
				        ...
				        echo "<td class='operaciones celda'><a href='index.php?controlador=Vehiculo&operacion=modificarEstado&parametro=$vehiculo->id'><img class='icono' src='images/buttons/edit.png' alt='editar' title='Editar estado vehiculo'/></a></td>";
				        echo "</tr>";
				}
				?>
			</table>
